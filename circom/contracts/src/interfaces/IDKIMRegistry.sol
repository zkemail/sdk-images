...
/*
 * NOTE: Interface adapted from `IDKIMRegistry` in `@zk-email/zk-email-verify`
 * (repo: github.com/zkemail/zk-email-verify, commit: abe9d839d2518ef3f3f0a5fab2283fd672672dde)
 * to make this repository's generated contract bundles self-contained.
 */
