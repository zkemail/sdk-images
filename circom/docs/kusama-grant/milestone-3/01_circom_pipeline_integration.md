...
Runs in CI on every push via [`.github/workflows/circom-rust-tests.yml`](../../../../.github/workflows/circom-rust-tests.yml) (`payload::` and this named test, added alongside `contract::`). Example passing `test` job: [`manifest.json#L7-L11`](./manifest.json#L7-L11). For the current state of the branch, see the [Actions tab](https://github.com/zkemail/sdk-images/actions/workflows/circom-rust-tests.yml?query=branch%3Astaging).
