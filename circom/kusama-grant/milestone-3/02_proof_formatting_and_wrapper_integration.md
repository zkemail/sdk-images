...
**CI:** `TBD` -- same test as Milestone 3 [`01_circom_pipeline_integration.md`](./01_circom_pipeline_integration.md); not currently covered by [`circom-rust-tests.yml`](../../../.github/workflows/circom-rust-tests.yml) (scoped to `contract::`, this test lives in the crate-root `tests` module). CI coverage status tracked in `01`.
