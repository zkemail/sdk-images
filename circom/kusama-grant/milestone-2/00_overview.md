...
- Contract tests (including the real-proof fixture test above) run in CI on every push via [`.github/workflows/circom-contracts-tests.yml`](../../../.github/workflows/circom-contracts-tests.yml).
