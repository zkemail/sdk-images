...
use anyhow::Result;
use regex::Regex;
use sdk_utils::{Blueprint, DecomposedRegex, compute_signal_length};
use serde::Serialize;
use tera::{Context, Tera};
use zk_regex_compiler::{DecomposedRegexConfig, RegexPartConfig, gen_circom_from_decomposed_regex};
...
pub fn generate_circuit(circuit_template_input: CircuitTemplateInputs) -> Result<String> {
    ...
    tera.add_template_file("./templates/template.nr.tera", Some("src/main.nr"))?;
